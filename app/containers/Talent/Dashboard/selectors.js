...
const makeSelectReferEarnType = () =>
  createSelector(
    homepageInviteForm,
    formState => formState.referEarnType,
  );
...
export { homepageInviteForm, makeSelectInviteMails, firstName, lastName, email, currency, rate, makeSelectReferEarnType };
