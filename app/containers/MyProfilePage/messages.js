...
export const scope = 'CodeMonk.containers.MyProfilePage';
...
export default defineMessages({
  ...
  interviewedForSkillsAndExpertise: {
    ...
    defineMessages: 'Interviewed for skills and expertise',
  },
  checkedForEducationAndExperiences: {
    id: `${scope}.checkedForEducationAndExperiences`,
    defineMessages: 'Checked for education and experiences',
  },
  verifiedPhotoIDandAddress: {
    id: `${scope}.verifiedPhotoIDandAddress`,
    defineMessages: 'Verified photo ID and address',
  },
});
