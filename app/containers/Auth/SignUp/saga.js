  ...
  try {
    ...
    if (get(log, 'status')) {
      ...
      if (agencyTalent) {
        ...
        if (StorageService.get('selectedRoleType') === 'client' || StorageService.get('selectedRoleType') === 'company') {
        ...
        } else if (StorageService.get('selectedRoleType') === 'recruiter') {
          pathname = `${TALENT_PARTNER}/verification`;
        } else if (StorageService.get('selectedRoleType') === 'ambassador') {
          pathname = `${AMBASSADOR}/verification`;
        }
      }
