...
import { closeIcon, API_URL, USER, PICTURE_API } from 'containers/App/constants';
import request from 'utils/request';
import * as formValidations from 'utils/formValidations';
import Emitter from 'utils/emitter';
import ToastifyMessage from 'components/ToastifyMessage';
import { FormLabel, P, H4, Button } from 'components';
...
export class AboutYouFields extends React.Component {
  ...
  render() {
    const { firstName, lastName, jobTitle, onChangeFirstName, onChangeLastName, onChangeJobTitle } = this.props;
