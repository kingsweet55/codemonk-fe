...
import brandingDarkIcon from '../../images/logo-codemonk-icon-dark.svg';
import brandingIcon from '../../images/logo-codemonk-icon.svg';
import brandDarkImage from '../../images/cm-logo.svg';
...
import clientsGIcon from '../../images/icons/clients-gradient.svg';
import teamGIcon from '../../images/icons/team-gradient.svg';
import quotesGIcon from '../../images/icons/quotes-gradient.svg';
...
import leftSectionBG from '../../images/left-image.svg';
...
export const VERIFY = 'CodeMonk/App/VERIFY/';
export const VERIFY_PHONE_OTP = 'CodeMonk/App/VERIFY_PHONE_OTP/';
export const RESET = 'CodeMonk/App/RESET/';
export const RESEND_CODE = 'CodeMonk/App/RESEND_CODE/';
export const LOGOUT = 'CodeMonk/App/LOGOUT';
export const POP_UP_SAGA = 'CodeMonk/App/POP_UP_SAGA';
...
export const PRIVACY_POLICY_URL = 'https://www.codemonk.ai/privacy-policy/';
export const TERMS_CONDITION_URL = 'https://www.codemonk.ai/terms-and-conditions/';
export const COOKIE_POLICY_URL = 'https://www.codemonk.ai/cookie-policy/';
export const ACCEPTABLE_POLICY_URL = 'https://www.codemonk.ai/acceptable-use-policy/';
...
export const CM_FACEBOOK_URL = 'https://www.facebook.com/codemonk.fow/';
export const CM_SLACK_URL = 'https://codemonk-network.slack.com/';
...
export const REFERRAL_TERMS = 'https://www.codemonk.ai/referral-terms';
...
export const teamPreferenceArray = [
  ...
  {
    id: 2,
    label: 'Small team (<6 members)',
    isChecked: false,
    value: 'small-team',
  },
  {
    id: 3,
    label: 'Medium Team(7-12 members)',
    isChecked: false,
    value: 'medium-team',
  },
  {
    id: 4,
    label: 'Large team (12+ members)',
    isChecked: false,
    value: 'large-team',
  },
];
...
export const routes = [
  {
    paths: [{ path: `${TALENT}`, exact: true }, { path: `${TALENT}/`, exact: true }, { path: TALENT_DASHBOARD, exact: false }],
    headerTitle: 'Dashboard',
    key: 'Talent_Dashboard',
  },
  {
    paths: [{ path: `${TALENT}/my-profile`, exact: false }],
    headerTitle: 'My profile',
    key: 'Talent_MyProfilePage',
  },
  {
    paths: [{ path: `${TALENT}/account-settings`, exact: false }],
    headerTitle: 'Account settings',
    key: 'AccountSettingsPage',
  },
  {
    paths: [{ path: `${TALENT}/timesheets`, exact: false }],
    headerTitle: 'Timesheets',
    key: 'Talent_Timesheets',
  },
  {
    paths: [{ path: `${TALENT}/job-briefs`, exact: false }],
    headerTitle: 'Briefs',
    key: 'TalentBriefs',
  },
  {
    paths: [{ path: `${TALENT}/brief-detail/:briefID`, exact: false }],
    headerTitle: 'Briefs',
    key: 'TalentBriefsDetail',
  },
  {
    paths: [{ path: `${TALENT}/knowledge-base`, exact: false }],
    headerTitle: 'Knowledge base',
    key: 'TalentKnowledgeBase',
  },
  {
    paths: [{ path: `${TALENT}/career-paths`, exact: false }],
    headerTitle: 'Career paths',
    key: 'TalentCareerPath',
  },
  {
    paths: [{ path: `${TALENT}/learning-development`, exact: false }],
    headerTitle: 'Learning development',
    key: 'TalentLearningDevelopment',
  },
  {
    paths: [{ path: `${TALENT}/perks`, exact: false }],
    headerTitle: 'Perks',
    key: 'TalentPerks',
  },
  {
    paths: [{ path: `${TALENT}/wellbeing`, exact: false }],
    headerTitle: 'Wellbeing',
    key: 'TalentWellbeing',
  },
  {
    paths: [{ path: `${TALENT}/invoices`, exact: false }],
    headerTitle: 'Inovice',
    key: 'Talent_Invoices',
  },
  {
    paths: [{ path: `${TALENT}/my-projects`, exact: false }],
  ...
  {
    paths: [{ path: `${AGENCY}`, exact: true }, { path: `${AGENCY}/`, exact: true }, { path: AGENCY_DASHBOARD, exact: false }],
    headerTitle: 'Dashboard',
    key: 'Agency_Dashboard',
  },
  {
    paths: [{ path: `${AGENCY}/agency-profile`, exact: false }],
    headerTitle: 'My profile',
    key: 'AgencyProfilePage',
  },
  {
    paths: [{ path: `${AGENCY}/agency-account-settings`, exact: false }],
    headerTitle: 'Account settings',
    key: 'AgencyAccountSettingsPage',
  },
  {
    paths: [{ path: `${AGENCY}/quotes`, exact: false }],
    headerTitle: 'Quotes',
    key: 'AgencyQuotes',
  },
  {
  ...
  {
    paths: [{ path: `${AGENCY}/agency-projects`, exact: false }],
    headerTitle: 'Projects',
  ...
  {
    paths: [{ path: `${AGENCY}/timesheets`, exact: false }],
    headerTitle: 'Timesheets',
    key: 'Agency_Timesheets',
  },
  {
    paths: [{ path: `${AGENCY}/invoices`, exact: false }],
    headerTitle: 'Invoices',
    key: 'Agency_Invoices',
  },
  {
    paths: [{ path: `${AGENCY}/agency-statements`, exact: false }],
    headerTitle: 'Statements',
    key: 'AgencyStatements',
  },
  {
    paths: [{ path: `${AGENCY}/my-team`, exact: false }],
    headerTitle: 'My team',
    key: 'AgencyMyTeam',
  },
  {
    paths: [{ path: `${AGENCY}/agency-planning`, exact: false }],
  ...
  {
    paths: [{ path: `${CLIENT}`, exact: true }, { path: `${CLIENT}/`, exact: true }, { path: CLIENT_DASHBOARD, exact: false }],
    headerTitle: 'Dashboard',
    key: 'Client_Dashboard',
  },
  {
    paths: [{ path: `${CLIENT}/start-project`, exact: false }],
    headerTitle: 'Start projects',
    key: 'StartProjectPage',
  },
  {
    paths: [{ path: `${CLIENT}/request-received`, exact: false }],
    headerTitle: 'Start projects',
    key: 'RequestReceivedPage',
  },
  {
    paths: [{ path: `${CLIENT}/talent-listing`, exact: false }],
    headerTitle: 'Talents',
    key: 'TalentListingPage',
  },
  {
    paths: [{ path: `${CLIENT}/my-profile`, exact: false }],
    headerTitle: 'My profile',
    key: 'ClientProfile',
  },
  {
  ...
  {
    paths: [{ path: `${CLIENT}/account-settings`, exact: false }],
    headerTitle: 'Account settings',
    key: 'ClientAccountSettingsPage',
  },
  {
    paths: [{ path: `${CLIENT}/job-briefs`, exact: false }],
    headerTitle: 'Briefs',
    key: 'ClientBrief',
  },
  {
    paths: [{ path: `${CLIENT}/brief-detail/:briefID`, exact: false }],
    headerTitle: 'Briefs',
    key: 'ClientBriefDetail',
  },
  {
    paths: [{ path: `${CLIENT}/projects`, exact: false }],
    headerTitle: 'Projects',
    key: 'ClientProjects',
  },
  {
    paths: [{ path: `${CLIENT}/talents`, exact: false }],
    headerTitle: 'Talents',
    key: 'ClientTalents',
  },
  {
    paths: [{ path: `${CLIENT}/billing`, exact: false }],
    headerTitle: 'Billing',
    key: 'ClientBilling',
  },
  {
    paths: [{ path: `${CLIENT}/contracts`, exact: false }],
    headerTitle: 'Contracts',
    key: 'ClientContracts',
  },
  {
    paths: [{ path: `${CLIENT}/payments`, exact: false }],
  ...
  {
    paths: [{ path: `${CLIENT}/timesheets`, exact: false }],
    headerTitle: 'Timesheets',
    key: 'Client_Timesheets',
  },
  {
    paths: [{ path: `${ADMIN}`, exact: true }, { path: `${ADMIN}/`, exact: true }, { path: `${ADMIN}/dashboard`, exact: false }],
    headerTitle: 'Dashboard',
    key: 'Admin_Dashboard',
  },
  {
    paths: [{ path: `${ADMIN}/projects`, exact: false }],
    headerTitle: 'Projects',
    key: 'AdminProjects',
  },
  {
    paths: [{ path: `${ADMIN}/job-briefs`, exact: false }],
    headerTitle: 'Briefs',
    key: 'Admin_Brief',
  },
  {
    paths: [{ path: `${ADMIN}/interviews`, exact: false }],
    headerTitle: 'Interviews',
    key: 'InterviewRequests',
  },
  {
    paths: [{ path: `${ADMIN}/quotes`, exact: false }],
    headerTitle: 'Quotes',
    key: 'Quotes',
  },
  {
    paths: [{ path: `${ADMIN}/talents`, exact: false }],
    headerTitle: 'Talents',
    key: 'AdminTalents',
  },
  {
    paths: [{ path: `${ADMIN}/timesheets`, exact: false }],
    headerTitle: 'Timesheets',
    key: 'Admin_Timesheets',
  },
  {
    paths: [{ path: `${ADMIN}/clients`, exact: false }],
    headerTitle: 'Clients',
    key: 'AdminClients',
  },
  {
    paths: [{ path: `${ADMIN}/agencies`, exact: false }],
  ...
  {
    paths: [{ path: `${ADMIN}/brief-detail/:briefID`, exact: false }],
    headerTitle: 'Briefs',
    key: 'Admin_BriefDetail',
  },
  {
  ...
  {
    paths: [{ path: `${ADMIN}/referrals`, exact: false }],
    headerTitle: 'Referrals',
    key: 'Referrals',
  },
  {
    paths: [{ path: `${ADMIN}/talent-partners`, exact: false }],
  ...
  {
    paths: [{ path: `${ADMIN}/ambassadors`, exact: false }],
  ...
  },
  {
    paths: [
      ...
      { path: `${TALENT_PARTNER}/`, exact: true },
      { path: `${TALENT_PARTNER}/dashboard`, exact: false },
    ],
    headerTitle: 'Dashboard',
    key: 'RecruiterDashboard',
  },
  {
    paths: [{ path: `${TALENT_PARTNER}/job-briefs`, exact: false }],
    headerTitle: 'Jobs',
    key: 'RecruiterBriefs',
  },
  {
    paths: [{ path: `${TALENT_PARTNER}/brief-detail/:briefID`, exact: false }],
    headerTitle: 'Jobs',
    key: 'RecruiterBriefDetail',
  },
  {
    paths: [
      { path: `${AMBASSADOR}`, exact: true },
      { path: `${AMBASSADOR}/`, exact: true },
      { path: `${AMBASSADOR}/dashboard`, exact: false },
    ],
    headerTitle: 'Dashboard',
    key: 'AmbassadorDashboard',
  },
  {
    paths: [{ path: `${AMBASSADOR}/talents`, exact: false }],
    headerTitle: 'Talents',
