...
export class TalentListingPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      companyCultures: [],
      certification: [],
      currentSort: (clientTalentSort && SORT_TALENTS.find(item => clientTalentSort === item.value)) || SORT_TALENTS[0],
    };
            ...
            <div className="d-flex justify-content-between align-items-center flex-column flex-md-row mb-3">
              ...
              <FilterAction className="d-flex">
                <SortSection className="ms-3">
                  ...
                  <SortComponent showSortIcon sortArray={SORT_TALENTS} currentSort={currentSort} handleSortChange={this.handleSortChange} />
                </SortSection>
              </FilterAction>
            </div>
