...
export const SORT_TYPE = {
  recommend: { label: 'Recommended', value: 'recommend' },
  lastest: { label: 'Lastest first', value: 'lastest' },
  oldest: { label: 'Oldest first', value: 'oldest' },
  seniority: { label: 'Seniority', value: 'seniority' },
  mostRecent: { label: 'Most Recent', value: 'talentHighToLow' },
  aToZ: { label: 'Name (A-Z)', value: 'talentAToZ' },
  zToA: { label: 'Name (Z-A)', value: 'talentZToA' },
  expLowToHigh: { label: 'Experience (Low to High)', value: 'lowToHigh_Exp' },
  expHighToLow: { label: 'Experience (High to Low)', value: 'highToLow_Exp' },
};

// eslint-disable-next-line prettier/prettier
export const SORT_BRIEFS = [
  SORT_TYPE.recommend,
  SORT_TYPE.lastest,
  SORT_TYPE.oldest,
  SORT_TYPE.seniority,
...
// eslint-disable-next-line prettier/prettier
export const SORT_TALENTS = [
  SORT_TYPE.aToZ,
  SORT_TYPE.zToA,
  SORT_TYPE.expLowToHigh,
  SORT_TYPE.expHighToLow,
];
