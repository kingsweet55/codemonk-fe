...
export default defineMessages({
  ...
  // hireTalent
  interviewTalentTitle: {
    id: `${scope}.interviewTalentTitle`,
    defaultMessage: 'Request to interview this talent ?',
  },
  shortlistTalentTitle: {
    id: `${scope}.shortlistTalentTitle`,
    defaultMessage: 'Move this talent to shortlist ?',
  },
  hireTalentTitle: {
  ...
  rejectTalentTitle: {
    id: `${scope}.rejectTalentTitle`,
    defaultMessage: 'Are you sure to reject this talent ?',
  },
  allocateTalentTitle: {
