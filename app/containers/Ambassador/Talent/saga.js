...
import { API_URL, VERSION2, AMBASSADOR, STATUS } from 'containers/App/constants';
...
export function* updateStatus(data) {
  ...
  const requestURL = `${API_URL}${VERSION2}${AMBASSADOR}${STATUS}`;
...
export default function* personalDetailsForm() {
  yield takeLatest(CHANGE_AMBASSADOR_STATUS, updateStatus);
}
