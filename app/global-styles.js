...
import { primaryDarkNew, successNew, white, dangerNew, primaryNew, black, darkGray, lightGray } from 'themes/variables';
...
const GlobalStyle = createGlobalStyle`
  ...
  .Toast > div.Toast-Error , .Toast > div.Toast-error {
    border-bottom: 3px solid rgb(${dangerNew}); 
  }


  .Toast > div.Toast-Success , .Toast > div.Toast-success {
    border-bottom: 3px solid rgb(${successNew}); 
  }
